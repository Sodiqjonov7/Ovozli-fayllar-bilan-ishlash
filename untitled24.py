...
# Example usage
wav_file_path = '1.wav'  # Replace with your WAV file path
...
# Example usage
wav_file_path = '2.wav'  # Replace with your WAV file path
generate_spectrogram(wav_file_path)
...
# Example usage
wav_file_path = '3.wav'  # Replace with your WAV file path
generate_spectrogram(wav_file_path)